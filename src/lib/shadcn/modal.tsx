...
>(({ className, close, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md" onClick={close}>
...
const DialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn('flex flex-col font-medium space-y-1.5 text-center sm:text-left', className)}
    {...props}
  />
);
